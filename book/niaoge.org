...
*** 进站与欢迎讯息
[[file:../language/shell.md::484][详细见此处]]

*** 环境配置
[[file:../language/shell.md::343][详细见此处]]
...
** 数据流重导向
[[file:../language/shell.md::202][详细见此处]]
** 管线命令               
*** 撰取命令:cut, grep
- cut
  #+BEGIN_SRC shell
...
*** 基础正则表达式字符汇整
[[file:../lauguage/shell.md::525][查看此处]]
...
*** 格式化打印:printf
[[file:../language/shell.md::560][看这里]]

*** awk:好用的数据处理工具
[[file:../language/shell.md::563][看这里]]
